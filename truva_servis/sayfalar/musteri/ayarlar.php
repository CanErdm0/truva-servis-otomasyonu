    ...
    <div class="container-fluid">
        ...
        <div class="card-body">
            ...
            <div class="form-group">
                <label>Ad</label>
                <input type="text" class="form-control" name="ad" id="ad" placeholder="<?=$kullanici_bilgileri["ad"]?>">
            </div>
            <div class="form-group">
                <label>Soyad</label>
                <input type="text" class="form-control" name="soyad" id="soyad" placeholder="<?=$kullanici_bilgileri["soyad"]?>">
            </div>

            <div class="form-group">
                <label>Telefon</label>
                <input type="tel" class="form-control" id="telefon" name="telefon" placeholder="<?=$kullanici_bilgileri["telefon"]?>">
            </div>
            ...
            function ilceyiYukle(sehirID) {
                ...
                ilgiliIlceler.forEach(ilce => {
                    options += `<option value="${ilce.id}">${ilce.name}</option>`;
                });
                ilceSelect.innerHTML = options;
            }
            
            document.getElementById("ilce").addEventListener("change", function () {
                const ilceID = this.value.toString();
                document.getElementById("mahalle").innerHTML = `<option value="">Mahalle seçiniz</option>`;
            ...
            <div class="form-group">
                <label>Mahalle</label>
                <input type="text" name="mahalle" id="mahalle" placeholder="<?=$kullanici_bilgileri["mahalle"]?>" class="form-control">
            </div>

            <div class="form-group">
                <label>Cadde</label>
                <input type="text" name="cadde" id="cadde" placeholder="<?=$kullanici_bilgileri["cadde"]?>" class="form-control">
            </div>

            <div class="form-group">
                <label>Sokak</label>
                <input type="text" name="sokak" id="sokak" placeholder="<?=$kullanici_bilgileri["sokak"]?>" class="form-control">
            </div>

            <div class="form-group">
                <label>Daire</label>
                <input type="text" name="daire" id="daire" placeholder="<?=$kullanici_bilgileri["daire"]?>" class="form-control">
            </div>
            ...
            <h5>Müşteri Giriş Bilgileri</h5>

            <div class="form-group">
                <label>E-Posta</label>
                <input type="email" class="form-control" id="email" name="email" placeholder="<?=$kullanici_bilgileri["email"]?>">
            </div>
            ...
            <button type="button" onclick="musteri_ayarlar_guncelle(this)" class="btn btn-primary mt-3">
