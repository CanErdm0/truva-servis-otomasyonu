...
<div class="col-12">
    ...
    <?php endforeach; ?>
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" name="tarih" id="randevu_tarih" class="form-control" min="<?= date('Y-m-d') ?>" required>
                        </div>
...
?>
                    ...
                    <div class="card-footer">
                        ...
                        <button type="button" onclick="admin_randevu_al(this)" class="btn btn-primary">Randevuyu Kaydet</button>
                    </div>
            </div>
        </div>
    </section>
...
$(document).ready(function() {
    ...
    // Sayfa açıldığında bugünün saatlerini kontrol et
